...
import nivia from '../../assets/1.jpg'
import bottlewater from '../../assets/1 (1).jpg'
import bud from '../../assets/1 (2).jpg'
import knor from '../../assets/1 (3).jpg'
import gmorn from '../../assets/1 (4).jpg'
...
export const twentysevenslider =[
    {
        id: 1,
...
const discount = () =>{
    ...
    twentysevenslider.forEach((e, i)=>{
          const newPrice = twentysevenslider[i].newprice
         const initialPrice = twentysevenslider[i].oldprice
