...
import nivia from '../../assets/ororo (3).jpg'
import bottlewater from '../../assets/oraimo watch (3).jpg'
import bud from '../../assets/oraimo watch (2).jpg'
import knor from '../../assets/oraimo watch (1).jpg'
import gmorn from '../../assets/1 (2).jpg'
...
const discount = () =>{
    ...
    sixteenthslider.forEach((e, i)=>{
          const newPrice = sixteenthslider[i].newprice
         const initialPrice = sixteenthslider[i].oldprice
