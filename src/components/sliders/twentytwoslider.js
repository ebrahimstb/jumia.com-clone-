...
import nivia from '../../assets/fridge.jpg'
import bottlewater from '../../assets/lapi.jpg'
import bud from '../../assets/tv.jpg'
import knor from '../../assets/pooti (2).jpg'
import gmorn from '../../assets/1 (13).jpg'
import stove from '../../assets/1(2).jpg'
...
const discount = () =>{
    ...
    twentytwoslider.forEach((e, i)=>{
          const newPrice = twentytwoslider[i].newprice
         const initialPrice = twentytwoslider[i].oldprice
